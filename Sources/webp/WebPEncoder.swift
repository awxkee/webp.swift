...
public enum WebPEncoderError: Error {
    ...
    case encodingImageError
}

// This is the mapped error codes that libwebp.WebPEncode returns
...
public struct WebPEncoder {
    ...
    private func encode(_ dataPtr: UnsafeMutablePointer<UInt8>, importer: WebPPictureImporter,
        ...
        if resizeHeight > 0 && resizeWidth > 0 && originWidth != resizeWidth && originHeight != resizeHeight {
