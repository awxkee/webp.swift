...
func convertUIImageToCGImageWithRGBA(_ image: WebPPlatformImage) throws -> CGImage {
    guard let inputCGImage = image.cgImage(forProposedRect: nil, context: nil, hints: nil) else {
